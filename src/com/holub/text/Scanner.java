...
public class Scanner {
    ...
    public Token advance() throws ParseFailure {
        System.out.println("advance: " + currentToken);
        try {
            if (currentToken != null)    // not at end of file
            {
                inputPosition += currentToken.lexeme().length();
                currentToken = null;
                System.out.println("inputPosition: " + inputPosition);
    ...
    public static class Test {
        ...
        private static final Token COMMA = tokens.create("',"), IN = tokens.create("'IN'"), INPUT = tokens.create("INPUT"), IDENTIFIER = tokens.create("[a-z_][a-z_0-9]*");
